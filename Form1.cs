...
namespace LatihanADONET
{
    public partial class Form1 : Form
    {
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try 
            {
                string dbName = @"E:\22.11.4784\Module Praktikum 08 (ADO.NET)\LatihanADO.NET\Database\DbPerpustakaan.db";
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            // validasi nama harus diisi
            if (string.IsNullOrEmpty(txtNamaDelete.Text))
            {
                MessageBox.Show("Nama harus !!!", "Informasi", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                txtNamaDelete.Focus();
                return;
            ...
            {
                // set parameter untuk nama, angkatan dan npm
                cmd.Parameters.AddWithValue("@nama", txtNamaDelete.Text);
                cmd.Parameters.AddWithValue("@angkatan", txtAngkatanDelete.Text);
                cmd.Parameters.AddWithValue("@npm", txtNpmDelete.Text);
                result = cmd.ExecuteNonQuery();
            }
            catch (Exception ex)
